...
　
 ...
 2026/2/4:新たにsample/client(chrome)_class実装版 を追加  
 →複数デバイスに対応することを考えると、どう考えてもクラス化しておいたほうが楽なのでクラスに書き換えて複数デバイス対応を楽にできるようにしたサンプル
 2026/2/22:sample/client(chrome)_class実装版 について、クラスの定義を「m_BLE.js」というファイルに書くように変更
